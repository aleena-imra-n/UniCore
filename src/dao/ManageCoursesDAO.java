...
public class ManageCoursesDAO {
    ...
    private static final String SQL_INSERT =
        "INSERT INTO COURSES " +
        "(major_dept_id, category_id, course_code, course_name, credit_hours) " +
        "VALUES (?, ?, ?, ?, ?)";
    ...
    public int addCourse(int majorDeptId, int categoryId, String courseCode,
            String courseName, int creditHours, String prereqCode) throws SQLException {
    ...
    public boolean updateCourse(int courseId, String courseName,
            ...
            int categoryId, String prereqCode) throws SQLException {
