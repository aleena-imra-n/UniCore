...
public class CourseItem {
    ...
    private final int    recommendedSemester;  // e.g. 3 — which semester this course belongs to
    ...
    public CourseItem(int offeringId, String courseCode, String courseName,
                      int creditHours, int recommendedSemester,
    ...
    public String toString() {
        return courseCode + "  |  " + courseName + "  (Sem " + recommendedSemester + ")";
    }
}
