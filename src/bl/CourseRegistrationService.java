...
public class CourseRegistrationService {
     ...
     * again in the current semester — available for grade improvement.
     *
     * @return list of CourseItem for the improvement tab
     * @throws IllegalStateException if {@link #init} was not called first
     */
    public List<CourseItem> getImprovementCourses() {
        ensureInitialised();
        try {
            return dao.getImprovementCourses(studentId);
        } catch (SQLException e) {
            return List.of();
        }
    }
